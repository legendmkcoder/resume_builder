  ...
  return (
    <div className="p-8 max-w-[21cm] mx-auto bg-white">
      ...
      <div className="border-b-2 border-gray-200 pb-4 mb-6">
        <h1 className="text-4xl font-light text-gray-800">{personalInfo.fullName || 'Your Name'}</h1>
      ...
      {workExperience.length > 0 && (
        <div className="mb-8">
          <h2 className="text-xl font-light text-gray-800 mb-4 uppercase tracking-wider">Experience</h2>
          <div className="space-y-6">
            {workExperience.map((experience) => (
              <div key={experience.id}>
                ...
                <p className="mt-2 text-gray-600 text-sm">{experience.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {education.length > 0 && (
        <div className="mb-8">
          <h2 className="text-xl font-light text-gray-800 mb-4 uppercase tracking-wider">Education</h2>
      ...
      {skills.length > 0 && (
        <div className="mb-8">
          <h2 className="text-xl font-light text-gray-800 mb-4 uppercase tracking-wider">Skills</h2>
      ...
      {projects.length > 0 && (
        <div className="mb-8">
          <h2 className="text-xl font-light text-gray-800 mb-4 uppercase tracking-wider">Projects</h2>
          <div className="space-y-4">
